        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomIdConfig = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryUserAccesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "NameEn", "NameRu", "Prefix" },
                values: new object[,]
                {
                    { 1, "Electronics", "Электроника", "ELEC" },
                    { 2, "Books", "Книги", "BOOK" },
                    { 3, "Apparel", "Одежда и обувь", "WEAR" },
                    { 4, "Furniture", "Мебель", "FURN" },
                    { 5, "Tools", "Инструменты", "TOOL" },
                    { 6, "Automotive", "Автотовары", "AUTO" },
                    { 7, "Sports", "Спортивные товары", "SPORT" },
                    { 8, "Medical", "Медицинские товары", "MEDI" },
                    { 9, "Food", "Продукты питания", "FOOD" },
                    { 10, "Cosmetics", "Косметика и уход", "COSM" },
                    { 11, "Construction", "Строительные материалы", "CONS" },
                    { 12, "Miscellaneous", "Прочее", "MISC" }
                });
